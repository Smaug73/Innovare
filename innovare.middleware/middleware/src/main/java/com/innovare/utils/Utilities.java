...
public final class Utilities {
	...
	public static final String kcFilePath=System.getProperty("user.home")+System.getProperty("file.separator")+"InnovareData"+System.getProperty("file.separator")+"kc.csv";
	...
	public static final float capacita=(float) 0.2;
}
