...
public class StoricoView extends Div{
	...
	private Component createContent() {
		...
		FlexBoxLayout content = new FlexBoxLayout(classifications, temperatures);
	...
	private Component createClassificationsChart() {
        ...
        configuration.addSeries(new ListSeries("Carenza di acqua", 15, 10, 5, 10, 20));
        configuration.addSeries(new ListSeries("Sane", 75, 80, 95, 75, 70));
        configuration.addSeries(new ListSeries("Eccesso di acqua", 10, 10, 0, 15, 10));
        

        XAxis x = new XAxis();
        x.setCrosshair(new Crosshair());
        x.setCategories("28/07/2020", "08/08/2020", "18/08/2020", "28/08/2020", "08/09/2020");
        configuration.addxAxis(x);

        YAxis y = new YAxis();
        y.setMin(0);
        y.setTitle("Percentuale [%]");
	...
	private Component createTemperaturesVariationChart() {
        ...
        RangeSeries data = new RangeSeries("Temperatura", getRawData());
